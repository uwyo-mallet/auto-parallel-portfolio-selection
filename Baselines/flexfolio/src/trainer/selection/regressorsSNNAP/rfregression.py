...
class RandomForrestRegressionSNNAP(SNNAPTrainer):
    '''
    ...
    def __init__(self, k, best_n=3, max_features=None, min_samples_leaf=None, save_models=True):
        '''
        Constructor
        '''
