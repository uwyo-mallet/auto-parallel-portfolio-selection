...
python2.7 src/helpers/transform_satzilla.py --file ./src/helpers/satzilla11_data/SATRAND11.csv --listfile ./src/helpers/satzilla11_data/random.list --fgroup ./src/helpers/satzilla11_data/f_group_dict.json --dir ./src/helpers/sat11-rand/ --cutoff 5000 --fcutoff 5000 --name SAT11-RANDOM
python2.7 src/helpers/transform_satzilla.py --file ./src/helpers/satzilla11_data/SATINDU11.csv --listfile ./src/helpers/satzilla11_data/indus.list --fgroup ./src/helpers/satzilla11_data/f_group_dict.json --dir ./src/helpers/sat11-indu --cutoff 5000 --fcutoff 5000 --name SAT11-INDU
python2.7 src/helpers/transform_satzilla.py --file ./src/helpers/satzilla11_data/SATHAND11.csv --listfile ./src/helpers/satzilla11_data/crafted.list --fgroup ./src/helpers/satzilla11_data/f_group_dict.json --dir ./src/helpers/sat11-hand/ --cutoff 5000 --fcutoff 5000 --name SAT11-CRAFTED
'''
import sys
import argparse
import os
...
class Transformer(object):
    ...
    def read_in(self, file_, list_file_, fgroup_file):
        
        # read list file to find instance id mapping
        fp = open(list_file_,"r")
        id_inst_list = []
        for line in fp:
            id_inst_list.append(line.replace("\n",""))  
        fp.close()
        ...
        return times, stati, features, sat_unsat, solver_names, feature_names, feature_times, fgroup_dict, fgroup_order, fgroup_dep, presolved
    
    def write_out(self, runtimes, stati, features, sat_unsat, solver_names, feature_names, feature_times, fgroup_dict, fgroup_order, fgroup_dep, presolved, dir_, relation_name, cutoff, f_cutoff, memlimit):
    ...
    def main(self):
        ...
        times, stati, features, sat_unsat, solver_names, feature_names, feature_times, fgroup_dict, fgroup_order, presolved, fgroup_dep = self.read_in(args.file_,args.list_file_, args.fgroup_file_)
