    ...
    for path in paths:
        ...
        for inst in paths[path]:
            ...
            with open(job_file, "a") as file:
                ...
                file.write('#SBATCH --partition=teton\n')
                ...
                file.write("module load swset/2018.05\nmodule load gcc/7.3.0\nmodule load boost/1.72.0\nsrun /usr/bin/time -f %%e %s/solve_subgraph_isomorphism glasgow2 %s %s" % (base_dir, inst_path_pattern, inst_path_target)) 
